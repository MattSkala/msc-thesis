...
%It is worth mentioning that there has been a long track of efforts to make mobile peer to peer systems work at TU Delft. There is a trustchain-android\footnote{https://github.com/Tribler/trustchain-android} project which implements TrustChain-inspired ledger and a basic UDP hole punching protocol. It has been written in Java, but the protocol is not compatible with TrustChain implemented as part of the py-ipv8 library. After analyzing the source code, it has been decided not to continue with the project.
